...
TARGET_CLASS = 'com/android/systemui/newstatusbar/controllers/ElementController$NotCalculateHoleInLine.smali'
CLASS_FALLBACK_NAMES = ['ElementController$NotCalculateHoleInLine.smali']
REQUIRED = True
REASON = "Legend MiuiSystemUI converted dex payload added class"
CLASS_CONTENT = """.class public final enum Lcom/android/systemui/newstatusbar/controllers/ElementController$NotCalculateHoleInLine;
...
PATCHES = [
    {
        "id": 'class_add_com_android_systemui_newstatusbar_controllers_ElementController_NotCalculateHoleInLine',
        "type": "class_add",
        "method": "",
        "method_name": "",
        "search": None,
