...
CLASS_CONTENT = """.class public interface abstract Lcom/android/systemui/newstatusbar/controllers/ElementController$CallBack;
...
PATCHES = [
    {
        "id": 'class_add_com_android_systemui_newstatusbar_controllers_ElementController_CallBack',
        "type": "class_add",
        "method": "",
        "method_name": "",
        "search": None,
