...
TARGET_CLASS = 'com/android/provision/global/NoPairingActivity.smali'
CLASS_FALLBACK_NAMES = ['NoPairingActivity.smali']
CLASS_ANCHORS = ['.super Lmiuix/appcompat/app/AppCompatActivity;']

PATCHES = [
    {
        'id': 'com_android_provision_global_NoPairingActivity__onCreate',
