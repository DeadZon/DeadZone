...
TARGET_CLASS = 'com/xiaomi/onetrack/util/u.smali'
CLASS_FALLBACK_NAMES = ['u.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_u__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/util/u;
