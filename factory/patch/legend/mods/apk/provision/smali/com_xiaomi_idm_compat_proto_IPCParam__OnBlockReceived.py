...
TARGET_CLASS = 'com/xiaomi/idm/compat/proto/IPCParam$OnBlockReceived.smali'
CLASS_FALLBACK_NAMES = ['IPCParam$OnBlockReceived.smali']
CLASS_ANCHORS = ['.super Lcom/google/protobuf/GeneratedMessageLite;', '.implements Lcom/google/protobuf/MessageLiteOrBuilder;', '.field public static final BLOCKFRAGMENT_FIELD_NUMBER:I = 0x3', '.field public static final CLIENTID_FIELD_NUMBER:I = 0x1', '.field private static final DEFAULT_INSTANCE:Lcom/xiaomi/idm/compat/proto/IPCParam$OnBlockReceived;', '.field public static final SERVICEID_FIELD_NUMBER:I = 0x2']

PATCHES = [
    {
        'id': 'com_xiaomi_idm_compat_proto_IPCParam__OnBlockReceived__dynamicMethod',
    ...
    invoke-direct {p0, p1}, Lcom/xiaomi/idm/compat/proto/IPCParam$OnBlockReceived$Builder;-><init>(Lcom/xiaomi/idm/compat/proto/IPCParam$1;)V
