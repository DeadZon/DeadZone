...
TARGET_CLASS = 'com/xiaomi/onetrack/util/oaid/a/f$a.smali'
CLASS_FALLBACK_NAMES = ['f$a.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;', '.implements Landroid/os/IInterface;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_oaid_a_f__a__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/util/oaid/a/f$a;
