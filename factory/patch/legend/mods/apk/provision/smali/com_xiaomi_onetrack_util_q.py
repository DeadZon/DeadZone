...
TARGET_CLASS = 'com/xiaomi/onetrack/util/q.smali'
CLASS_FALLBACK_NAMES = ['q.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_q__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/util/q;
