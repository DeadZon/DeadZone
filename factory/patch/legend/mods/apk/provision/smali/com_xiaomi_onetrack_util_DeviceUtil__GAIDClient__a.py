...
TARGET_CLASS = 'com/xiaomi/onetrack/util/DeviceUtil$GAIDClient$a.smali'
CLASS_FALLBACK_NAMES = ['DeviceUtil$GAIDClient$a.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;', '.implements Landroid/os/IInterface;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_DeviceUtil__GAIDClient__a__class_delete',
        'type': 'class_delete',
        'search': """.class final Lcom/xiaomi/onetrack/util/DeviceUtil$GAIDClient$a;
