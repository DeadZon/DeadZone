...
TARGET_CLASS = 'com/xiaomi/onetrack/util/DeviceUtil$GAIDClient.smali'
CLASS_FALLBACK_NAMES = ['DeviceUtil$GAIDClient.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_DeviceUtil__GAIDClient__class_delete',
        'type': 'class_delete',
        'search': """.class Lcom/xiaomi/onetrack/util/DeviceUtil$GAIDClient;
