...
TARGET_CLASS = 'com/xiaomi/onetrack/util/z.smali'
CLASS_FALLBACK_NAMES = ['z.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;', '.field private static final c:Ljava/lang/String; = "com.xiaomi.onetrack.util.z"']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_z__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/util/z;
