...
TARGET_CLASS = 'com/xiaomi/onetrack/util/oaid/helpers/OnePlusDeviceIDHelper$1.smali'
CLASS_FALLBACK_NAMES = ['OnePlusDeviceIDHelper$1.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;', '.implements Landroid/content/ServiceConnection;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_oaid_helpers_OnePlusDeviceIDHelper__1__class_delete',
        'type': 'class_delete',
        'search': """.class Lcom/xiaomi/onetrack/util/oaid/helpers/OnePlusDeviceIDHelper$1;
