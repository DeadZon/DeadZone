...
TARGET_CLASS = 'com/xiaomi/onetrack/Configuration.smali'
CLASS_FALLBACK_NAMES = ['Configuration.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_Configuration__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/Configuration;
