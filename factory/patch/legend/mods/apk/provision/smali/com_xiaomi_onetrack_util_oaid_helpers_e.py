...
TARGET_CLASS = 'com/xiaomi/onetrack/util/oaid/helpers/e.smali'
CLASS_FALLBACK_NAMES = ['e.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_oaid_helpers_e__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/util/oaid/helpers/e;
