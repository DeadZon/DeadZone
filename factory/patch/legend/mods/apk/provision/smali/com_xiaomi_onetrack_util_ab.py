...
TARGET_CLASS = 'com/xiaomi/onetrack/util/ab.smali'
CLASS_FALLBACK_NAMES = ['ab.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_ab__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/util/ab;
