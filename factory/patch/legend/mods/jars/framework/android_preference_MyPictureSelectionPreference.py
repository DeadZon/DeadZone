...
Target class : android/preference/MyPictureSelectionPreference
...
TARGET_CLASS = "android/preference/MyPictureSelectionPreference.smali"
CLASS_FALLBACK_NAMES = ['MyPictureSelectionPreference.smali']
CLASS_ANCHORS        = []

PATCHES = [
    {
        "id":          "add_class_android_preference_MyPictureSelectionPreference",
        "method":      "",
        "type":        "class_add",
        "search":      None,
        "replacement": """\
