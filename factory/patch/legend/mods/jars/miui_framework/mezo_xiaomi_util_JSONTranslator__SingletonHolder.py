...
Target class : mezo/xiaomi/util/JSONTranslator$SingletonHolder
...
TARGET_CLASS = "mezo/xiaomi/util/JSONTranslator$SingletonHolder.smali"
CLASS_FALLBACK_NAMES = ['JSONTranslator$SingletonHolder.smali']
CLASS_ANCHORS        = []

PATCHES = [
    {
        "id":          "add_class_mezo_xiaomi_util_JSONTranslator__SingletonHolder",
        "method":      "",
        "type":        "class_add",
        "search":      None,
        "replacement": """\
