...
Target class : com/android/server/policy/VolBtnHelper
...
TARGET_CLASS = "com/android/server/policy/VolBtnHelper.smali"
CLASS_FALLBACK_NAMES = ['VolBtnHelper.smali']
CLASS_ANCHORS        = []

PATCHES = [
    {
        "id":          "add_class_com_android_server_policy_VolBtnHelper",
        "method":      "",
        "type":        "class_add",
        "search":      None,
        "replacement": """\
