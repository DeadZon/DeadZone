...
Target class : com/android/server/policy/PhoneWindowManager$MusicNext
...
TARGET_CLASS = "com/android/server/policy/PhoneWindowManager$MusicNext.smali"
CLASS_FALLBACK_NAMES = ['PhoneWindowManager$MusicNext.smali']
CLASS_ANCHORS        = []
