...
def apply(unpack_dir: Path, config: dict, dry_run: bool = True) -> dict[str, Any]:
    ...
    report["warnings"].append("process_control mod is not yet implemented.")
    return report
