...
def patch_jars(
    ...
    *,
    ...
    Delegates entirely to factory.patch.legend.mtcr.runner so there is one
    code path for JAR patching.
    """
    _log(report_lines, "[jar_patcher] Delegating to factory.patch.legend.mtcr.runner")

    try:
        mtcr = importlib.import_module("factory.patch.legend.mtcr.runner")
