"""
Legend MTCR patch: miui-framework.jar  <-  miui-framework_Legend.mtcr

Target:  system_ext/framework/miui-framework.jar
MTCR:    miui-framework_Legend.mtcr
Add-DEX: miui-freamwork add.dex  (typo preserved from source filename)

Exposes:
  apply_miui_framework_mtcr_patch(work_dir, report, execute) -> dict
"""
from __future__ import annotations

from pathlib import Path

PATCH_ID              = "legend_mtcr_miui_framework"
MTCR_FILENAME         = "miui-framework_Legend.mtcr"
TARGET_JAR_NAME       = "miui-framework.jar"
TARGET_JAR_PARTITION  = "system_ext"
TARGET_JAR_REL_PATH   = "framework/miui-framework.jar"
...
def apply_miui_framework_mtcr_patch(work_dir: Path, report: dict, execute: bool) -> dict:
    """
    Apply miui-framework_Legend.mtcr to the already-unpacked miui-framework.jar workspace.

    Parameters
    ----------
    work_dir : Path
        Directory containing smali_classes* dirs for miui-framework.jar.
    report : dict
