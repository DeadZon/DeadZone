...
Target class : android/preference/SettingsMezoHelper
...
TARGET_CLASS = "android/preference/SettingsMezoHelper.smali"
CLASS_FALLBACK_NAMES = ['SettingsMezoHelper.smali']
CLASS_ANCHORS        = []

PATCHES = [
    {
        "id":          "add_class_android_preference_SettingsMezoHelper",
        "method":      "",
        "type":        "class_add",
        "search":      None,
        "replacement": """\
