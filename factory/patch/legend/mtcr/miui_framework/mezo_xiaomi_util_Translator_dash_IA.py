...
Target class : mezo/xiaomi/util/Translator-IA
...
TARGET_CLASS = "mezo/xiaomi/util/Translator-IA.smali"
CLASS_FALLBACK_NAMES = ['Translator-IA.smali']
CLASS_ANCHORS        = []

PATCHES = [
    {
        "id":          "add_class_mezo_xiaomi_util_Translator_dash_IA",
        "method":      "",
        "type":        "class_add",
        "search":      None,
        "replacement": """\
