...
Target class : mezo/xiaomi/util/Translator
...
TARGET_CLASS = "mezo/xiaomi/util/Translator.smali"
CLASS_FALLBACK_NAMES = ['Translator.smali']
CLASS_ANCHORS        = []

PATCHES = [
    {
        "id":          "add_class_mezo_xiaomi_util_Translator",
        "method":      "",
        "type":        "class_add",
        "search":      None,
        "replacement": """\
