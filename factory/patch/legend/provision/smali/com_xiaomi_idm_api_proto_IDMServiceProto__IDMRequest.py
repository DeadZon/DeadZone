...
TARGET_CLASS = 'com/xiaomi/idm/api/proto/IDMServiceProto$IDMRequest.smali'
CLASS_FALLBACK_NAMES = ['IDMServiceProto$IDMRequest.smali']
CLASS_ANCHORS = ['.super Lcom/google/protobuf/GeneratedMessageLite;', '.implements Lcom/google/protobuf/MessageLiteOrBuilder;', '.field public static final AID_FIELD_NUMBER:I = 0x2', '.field public static final CLASSTYPE_FIELD_NUMBER:I = 0x7', '.field public static final CLIENTID_FIELD_NUMBER:I = 0x4', '.field private static final DEFAULT_INSTANCE:Lcom/xiaomi/idm/api/proto/IDMServiceProto$IDMRequest;']

PATCHES = [
    {
        'id': 'com_xiaomi_idm_api_proto_IDMServiceProto__IDMRequest__dynamicMethod',
    ...
    invoke-direct {p0, p1}, Lcom/xiaomi/idm/api/proto/IDMServiceProto$IDMRequest$Builder;-><init>(Lcom/xiaomi/idm/api/proto/IDMServiceProto$1;)V
