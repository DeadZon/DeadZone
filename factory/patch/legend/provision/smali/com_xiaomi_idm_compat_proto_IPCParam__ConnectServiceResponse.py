...
TARGET_CLASS = 'com/xiaomi/idm/compat/proto/IPCParam$ConnectServiceResponse.smali'
CLASS_FALLBACK_NAMES = ['IPCParam$ConnectServiceResponse.smali']
CLASS_ANCHORS = ['.super Lcom/google/protobuf/GeneratedMessageLite;', '.implements Lcom/google/protobuf/MessageLiteOrBuilder;', '.field private static final DEFAULT_INSTANCE:Lcom/xiaomi/idm/compat/proto/IPCParam$ConnectServiceResponse;', '.field public static final IDMCONNECTSERVICERESPONSE_FIELD_NUMBER:I = 0x1']

PATCHES = [
    {
        'id': 'com_xiaomi_idm_compat_proto_IPCParam__ConnectServiceResponse__dynamicMethod',
    ...
    :pswitch_4  #0x3
    const-string p0, "idmConnectServiceResponse_"
    ...
    invoke-direct {p0, p1}, Lcom/xiaomi/idm/compat/proto/IPCParam$ConnectServiceResponse$Builder;-><init>(Lcom/xiaomi/idm/compat/proto/IPCParam$1;)V
