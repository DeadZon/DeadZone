...
TARGET_CLASS = 'com/xiaomi/onetrack/util/oaid/a/b$a.smali'
CLASS_FALLBACK_NAMES = ['b$a.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;', '.implements Landroid/os/IInterface;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_oaid_a_b__a__class_delete',
        'type': 'class_delete',
        'search': """.class public final Lcom/xiaomi/onetrack/util/oaid/a/b$a;
