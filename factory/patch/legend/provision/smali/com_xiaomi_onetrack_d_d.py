...
TARGET_CLASS = 'com/xiaomi/onetrack/d/d.smali'
CLASS_FALLBACK_NAMES = ['d.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;', '.field private static final b:[C', '.field private static final c:[C']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_d_d__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/d/d;
