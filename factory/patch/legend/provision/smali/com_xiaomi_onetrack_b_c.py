...
TARGET_CLASS = 'com/xiaomi/onetrack/b/c.smali'
CLASS_FALLBACK_NAMES = ['c.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;', '.implements Ljava/lang/Runnable;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_b_c__class_delete',
        'type': 'class_delete',
        'search': """.class Lcom/xiaomi/onetrack/b/c;
...
.method public run()V
    ...
    const-wide v7, 0x413b774000000000L
