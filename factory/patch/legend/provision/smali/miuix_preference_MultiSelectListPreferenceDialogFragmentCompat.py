...
TARGET_CLASS = 'miuix/preference/MultiSelectListPreferenceDialogFragmentCompat.smali'
CLASS_FALLBACK_NAMES = ['MultiSelectListPreferenceDialogFragmentCompat.smali']
CLASS_ANCHORS = ['.super Landroidx/preference/MultiSelectListPreferenceDialogFragmentCompat;']

PATCHES = [
    {
        'id': 'miuix_preference_MultiSelectListPreferenceDialogFragmentCompat__onPrepareDialogBuilder',
...
.end method""",
    ...
    },
    {
        ...
        'method_name': 'onPrepareDialogBuilder',
        'method_anchors': ['new-instance v0, Lmiuix/preference/BuilderDelegate;', 'invoke-virtual {p0}, Landroidx/fragment/app/Fragment;->getContext()Landroid/content/Context;', 'invoke-direct {v0, v1, p1}, Lmiuix/preference/BuilderDelegate;-><init>(Landroid/content/Context;Lmiuix/appcompat/app/AlertDialog$Builder;)V', 'invoke-super {p0, v0}, Landroidx/preference/MultiSelectListPreferenceDialogFragmentCompat;->onPrepareDialogBuilder(Landroidx/appcompat/app/AlertDialog$Builder;)V', 'return-void'],
        'type': 'method_replace',
