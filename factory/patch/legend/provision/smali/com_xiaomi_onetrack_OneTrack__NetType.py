...
TARGET_CLASS = 'com/xiaomi/onetrack/OneTrack$NetType.smali'
CLASS_FALLBACK_NAMES = ['OneTrack$NetType.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Enum;', '.field public static final enum CONNECTED:Lcom/xiaomi/onetrack/OneTrack$NetType;', '.field public static final enum ETHERNET:Lcom/xiaomi/onetrack/OneTrack$NetType;', '.field public static final enum MOBILE_2G:Lcom/xiaomi/onetrack/OneTrack$NetType;', '.field public static final enum MOBILE_3G:Lcom/xiaomi/onetrack/OneTrack$NetType;', '.field public static final enum MOBILE_4G:Lcom/xiaomi/onetrack/OneTrack$NetType;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_OneTrack__NetType__class_delete',
        'type': 'class_delete',
        'search': """.class public final enum Lcom/xiaomi/onetrack/OneTrack$NetType;
