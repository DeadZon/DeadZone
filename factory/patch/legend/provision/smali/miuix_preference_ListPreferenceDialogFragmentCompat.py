...
TARGET_CLASS = 'miuix/preference/ListPreferenceDialogFragmentCompat.smali'
CLASS_FALLBACK_NAMES = ['ListPreferenceDialogFragmentCompat.smali']
CLASS_ANCHORS = ['.super Landroidx/preference/ListPreferenceDialogFragmentCompat;']

PATCHES = [
    {
        'id': 'miuix_preference_ListPreferenceDialogFragmentCompat__onPrepareDialogBuilder',
