...
TARGET_CLASS = 'com/xiaomi/onetrack/util/oaid/a/e$a.smali'
CLASS_FALLBACK_NAMES = ['e$a.smali']
CLASS_ANCHORS = ['.super Landroid/os/Binder;', '.implements Lcom/xiaomi/onetrack/util/oaid/a/e;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_oaid_a_e__a__class_delete',
        'type': 'class_delete',
        'search': """.class public abstract Lcom/xiaomi/onetrack/util/oaid/a/e$a;
