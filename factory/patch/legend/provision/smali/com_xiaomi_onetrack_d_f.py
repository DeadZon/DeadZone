...
TARGET_CLASS = 'com/xiaomi/onetrack/d/f.smali'
CLASS_FALLBACK_NAMES = ['f.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;', '.field public static final a:Lorg/json/JSONObject;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_d_f__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/d/f;
