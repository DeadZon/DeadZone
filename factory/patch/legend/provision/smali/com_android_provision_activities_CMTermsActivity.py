...
TARGET_CLASS = 'com/android/provision/activities/CMTermsActivity.smali'
CLASS_FALLBACK_NAMES = ['CMTermsActivity.smali']
CLASS_ANCHORS = ['.super Lcom/android/provision/activities/BaseActivity;']

PATCHES = [
    {
        'id': 'com_android_provision_activities_CMTermsActivity__getFragment',
        'method': '.method protected getFragment()Landroidx/fragment/app/Fragment;',
        'method_name': 'getFragment',
        'method_anchors': ['new-instance p0, Lcom/android/provision/fragment/CMTermsFragment;', 'invoke-direct {p0}, Lcom/android/provision/fragment/CMTermsFragment;-><init>()V', 'return-object p0'],
        'type': 'method_replace',
        'search': """.method protected getFragment()Landroidx/fragment/app/Fragment;
    .registers 1

    new-instance p0, Lcom/android/provision/fragment/CMTermsFragment;

    invoke-direct {p0}, Lcom/android/provision/fragment/CMTermsFragment;-><init>()V
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_CMTermsActivity__getFragmentTag',
    ...
    const-class p0, Lcom/android/provision/fragment/CMTermsFragment;
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_CMTermsActivity__getListDescCharSequence',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_CMTermsActivity__getLogoDrawableId',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_CMTermsActivity__getTitleStringId',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_CMTermsActivity__onCreate',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_CMTermsActivity__onResume',
