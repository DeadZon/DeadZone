...
TARGET_CLASS = 'miuix/slidingwidget/widget/SlidingButton.smali'
CLASS_FALLBACK_NAMES = ['SlidingButton.smali']
CLASS_ANCHORS = ['.super Landroidx/appcompat/widget/AppCompatCheckBox;']

PATCHES = [
    {
        'id': 'miuix_slidingwidget_widget_SlidingButton__drawableStateChanged',
        'method': '.method protected drawableStateChanged()V',
        'method_name': 'drawableStateChanged',
        'method_anchors': ['invoke-super {p0}, Landroidx/appcompat/widget/AppCompatCheckBox;->drawableStateChanged()V', 'iget-object p0, p0, Lmiuix/slidingwidget/widget/SlidingButton;->mHelper:Lmiuix/slidingwidget/widget/SlidingButtonHelper;', 'if-eqz p0, :cond_0', 'invoke-virtual {p0}, Lmiuix/slidingwidget/widget/SlidingButtonHelper;->setSliderDrawState()V', 'return-void'],
        'type': 'method_replace',
...
.end method""",
    ...
    {
        'id': 'miuix_slidingwidget_widget_SlidingButton__onDraw',
        'method': '.method protected onDraw(Landroid/graphics/Canvas;)V',
        'method_name': 'onDraw',
        'method_anchors': ['iget-object v0, p0, Lmiuix/slidingwidget/widget/SlidingButton;->mHelper:Lmiuix/slidingwidget/widget/SlidingButtonHelper;', 'if-nez v0, :cond_0', 'invoke-super {p0, p1}, Landroid/widget/CheckBox;->onDraw(Landroid/graphics/Canvas;)V', 'return-void', 'invoke-virtual {v0, p1}, Lmiuix/slidingwidget/widget/SlidingButtonHelper;->onDraw(Landroid/graphics/Canvas;)V', 'return-void'],
        'type': 'method_replace',
...
.end method""",
    ...
    {
        'id': 'miuix_slidingwidget_widget_SlidingButton__onSetAlpha',
...
.end method""",
    ...
    {
        'id': 'miuix_slidingwidget_widget_SlidingButton__verifyDrawable',
        'method': '.method protected verifyDrawable(Landroid/graphics/drawable/Drawable;)Z',
        'method_name': 'verifyDrawable',
        'method_anchors': ['invoke-super {p0, p1}, Landroid/widget/CheckBox;->verifyDrawable(Landroid/graphics/drawable/Drawable;)Z', 'if-nez v0, :cond_1', 'iget-object p0, p0, Lmiuix/slidingwidget/widget/SlidingButton;->mHelper:Lmiuix/slidingwidget/widget/SlidingButtonHelper;', 'if-eqz p0, :cond_0', 'invoke-virtual {p0, p1}, Lmiuix/slidingwidget/widget/SlidingButtonHelper;->verifyDrawable(Landroid/graphics/drawable/Drawable;)Z', 'if-eqz p0, :cond_0', 'return p0', 'return p0'],
        'type': 'method_replace',
