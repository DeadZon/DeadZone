...
TARGET_CLASS = 'com/xiaomi/onetrack/util/d.smali'
CLASS_FALLBACK_NAMES = ['d.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;', '.field private static final a:Ljava/lang/String; = "d"']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_d__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/util/d;
