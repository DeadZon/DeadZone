...
TARGET_CLASS = 'com/android/provision/activities/FontSizeActivity.smali'
CLASS_FALLBACK_NAMES = ['FontSizeActivity.smali']
CLASS_ANCHORS = ['.super Lcom/android/provision/activities/BaseActivity;']

PATCHES = [
    {
        'id': 'com_android_provision_activities_FontSizeActivity__getFragment',
        'method': '.method protected getFragment()Landroidx/fragment/app/Fragment;',
        'method_name': 'getFragment',
        'method_anchors': ['new-instance p0, Lcom/android/provision/fragment/FontSizeFragment;', 'invoke-direct {p0}, Lcom/android/provision/fragment/FontSizeFragment;-><init>()V', 'return-object p0'],
        'type': 'method_replace',
        'search': """.method protected getFragment()Landroidx/fragment/app/Fragment;
    .registers 1

    new-instance p0, Lcom/android/provision/fragment/FontSizeFragment;

    invoke-direct {p0}, Lcom/android/provision/fragment/FontSizeFragment;-><init>()V
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_FontSizeActivity__getFragmentTag',
    ...
    const-class p0, Lcom/android/provision/fragment/FontSizeFragment;
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_FontSizeActivity__getListDescCharSequence',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_FontSizeActivity__getLogoDrawableId',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_FontSizeActivity__getTitleStringId',
        'method': '.method protected getTitleStringId()I',
        'method_name': 'getTitleStringId',
        'method_anchors': ['sget p0, Lcom/android/provision/R$string;->font_size_title:I', 'return p0'],
        'type': 'method_replace',
        'search': """.method protected getTitleStringId()I
    .registers 1

    sget p0, Lcom/android/provision/R$string;->font_size_title:I
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_FontSizeActivity__onCreate',
