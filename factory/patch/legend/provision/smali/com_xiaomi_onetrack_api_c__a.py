...
TARGET_CLASS = 'com/xiaomi/onetrack/api/c$a.smali'
CLASS_FALLBACK_NAMES = ['c$a.smali']
CLASS_ANCHORS = ['.super Landroid/os/Handler;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_api_c__a__class_delete',
        'type': 'class_delete',
        'search': """.class Lcom/xiaomi/onetrack/api/c$a;
