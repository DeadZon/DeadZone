...
TARGET_CLASS = 'miuix/net/ConnectivityHelper$1.smali'
CLASS_FALLBACK_NAMES = ['ConnectivityHelper$1.smali']
CLASS_ANCHORS = ['.super Lmiuix/core/util/SoftReferenceSingleton;']

PATCHES = [
    {
        'id': 'miuix_net_ConnectivityHelper__1__class_delete',
        'type': 'class_delete',
        'search': """.class Lmiuix/net/ConnectivityHelper$1;
