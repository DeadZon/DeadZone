...
TARGET_CLASS = 'com/xiaomi/onetrack/util/DeviceUtil$GAIDClient$AdvertisingConnection.smali'
CLASS_FALLBACK_NAMES = ['DeviceUtil$GAIDClient$AdvertisingConnection.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;', '.implements Landroid/content/ServiceConnection;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_DeviceUtil__GAIDClient__AdvertisingConnection__class_delete',
        'type': 'class_delete',
        'search': """.class final Lcom/xiaomi/onetrack/util/DeviceUtil$GAIDClient$AdvertisingConnection;
