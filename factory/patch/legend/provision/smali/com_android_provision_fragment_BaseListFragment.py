...
TARGET_CLASS = 'com/android/provision/fragment/BaseListFragment.smali'
CLASS_FALLBACK_NAMES = ['BaseListFragment.smali']
CLASS_ANCHORS = ['.super Landroidx/fragment/app/ListFragment;']

PATCHES = [
    {
        'id': 'com_android_provision_fragment_BaseListFragment__getName',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_fragment_BaseListFragment__recordBottomButtonClick',
        'method': '.method protected recordBottomButtonClick(Ljava/lang/String;)V',
        'method_name': 'recordBottomButtonClick',
        'method_anchors': ['invoke-virtual {p0}, Landroidx/fragment/app/Fragment;->getActivity()Landroidx/fragment/app/FragmentActivity;', 'invoke-virtual {p0}, Lcom/android/provision/fragment/BaseListFragment;->getName()Ljava/lang/String;', 'invoke-static {v0, p0, p1}, Lcom/android/provision/utils/OTHelper;->rdBottomButtonEvent(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)V', 'return-void'],
        'type': 'method_replace',
    ...
    invoke-virtual {p0}, Lcom/android/provision/fragment/BaseListFragment;->getName()Ljava/lang/String;
...
.end method""",
    ...
    {
        'id': 'com_android_provision_fragment_BaseListFragment__recordPageStayTime',
        'method': '.method protected recordPageStayTime()V',
        'method_name': 'recordPageStayTime',
        'method_anchors': ['invoke-virtual {p0}, Lcom/android/provision/fragment/BaseListFragment;->getName()Ljava/lang/String;', 'invoke-static {}, Ljava/lang/System;->currentTimeMillis()J', 'iget-wide v3, p0, Lcom/android/provision/fragment/BaseListFragment;->mUserStayStartTime:J', 'invoke-static {v0, v1, v2}, Lcom/android/provision/utils/OTHelper;->rdPageStayTimeEvent(Ljava/lang/String;J)V', 'return-void'],
        'type': 'method_replace',
    ...
    iget-wide v3, p0, Lcom/android/provision/fragment/BaseListFragment;->mUserStayStartTime:J
