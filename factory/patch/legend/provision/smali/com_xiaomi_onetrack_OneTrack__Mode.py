...
TARGET_CLASS = 'com/xiaomi/onetrack/OneTrack$Mode.smali'
CLASS_FALLBACK_NAMES = ['OneTrack$Mode.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Enum;', '.field public static final enum APP:Lcom/xiaomi/onetrack/OneTrack$Mode;', '.field public static final enum PLUGIN:Lcom/xiaomi/onetrack/OneTrack$Mode;', '.field public static final enum SDK:Lcom/xiaomi/onetrack/OneTrack$Mode;', '.field private static final synthetic b:[Lcom/xiaomi/onetrack/OneTrack$Mode;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_OneTrack__Mode__class_delete',
        'type': 'class_delete',
        'search': """.class public final enum Lcom/xiaomi/onetrack/OneTrack$Mode;
