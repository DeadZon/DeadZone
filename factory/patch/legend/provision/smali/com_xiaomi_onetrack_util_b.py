...
TARGET_CLASS = 'com/xiaomi/onetrack/util/b.smali'
CLASS_FALLBACK_NAMES = ['b.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;', '.field private static final o:[Ljava/lang/String;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_b__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/util/b;
