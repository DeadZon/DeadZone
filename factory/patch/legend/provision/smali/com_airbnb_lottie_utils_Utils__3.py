...
TARGET_CLASS = 'com/airbnb/lottie/utils/Utils$3.smali'
CLASS_FALLBACK_NAMES = ['Utils$3.smali']
CLASS_ANCHORS = ['.super Ljava/lang/ThreadLocal;']

PATCHES = [
    {
        'id': 'com_airbnb_lottie_utils_Utils__3__initialValue',
        'method': '.method protected bridge synthetic initialValue()Ljava/lang/Object;',
        'method_name': 'initialValue',
        'method_anchors': ['invoke-virtual {p0}, Lcom/airbnb/lottie/utils/Utils$3;->initialValue()Landroid/graphics/Path;', 'return-object p0'],
        'type': 'method_replace',
