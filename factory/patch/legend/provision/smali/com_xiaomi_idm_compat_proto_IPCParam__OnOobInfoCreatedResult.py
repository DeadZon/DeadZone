...
TARGET_CLASS = 'com/xiaomi/idm/compat/proto/IPCParam$OnOobInfoCreatedResult.smali'
CLASS_FALLBACK_NAMES = ['IPCParam$OnOobInfoCreatedResult.smali']
CLASS_ANCHORS = ['.super Lcom/google/protobuf/GeneratedMessageLite;', '.implements Lcom/google/protobuf/MessageLiteOrBuilder;', '.field public static final CODE_FIELD_NUMBER:I = 0x2', '.field private static final DEFAULT_INSTANCE:Lcom/xiaomi/idm/compat/proto/IPCParam$OnOobInfoCreatedResult;', '.field public static final HEAD_FIELD_NUMBER:I = 0x1', '.field public static final OOBINFO_FIELD_NUMBER:I = 0x3']

PATCHES = [
    {
        'id': 'com_xiaomi_idm_compat_proto_IPCParam__OnOobInfoCreatedResult__dynamicMethod',
    ...
    invoke-direct {p0, p1}, Lcom/xiaomi/idm/compat/proto/IPCParam$OnOobInfoCreatedResult$Builder;-><init>(Lcom/xiaomi/idm/compat/proto/IPCParam$1;)V
