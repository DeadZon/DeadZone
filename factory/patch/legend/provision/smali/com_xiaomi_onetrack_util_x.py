...
TARGET_CLASS = 'com/xiaomi/onetrack/util/x.smali'
CLASS_FALLBACK_NAMES = ['x.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;', '.field private static final p:[B', '.field private static final q:[B', '.field private static final r:[B', '.field private static final s:[B', '.field private static final t:[B']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_x__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/util/x;
