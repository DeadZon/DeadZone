...
TARGET_CLASS = 'com/xiaomi/idm/api/proto/IDMServiceProto$BTConfig.smali'
CLASS_FALLBACK_NAMES = ['IDMServiceProto$BTConfig.smali']
CLASS_ANCHORS = ['.super Lcom/google/protobuf/GeneratedMessageLite;', '.implements Lcom/google/protobuf/MessageLiteOrBuilder;', '.field private static final DEFAULT_INSTANCE:Lcom/xiaomi/idm/api/proto/IDMServiceProto$BTConfig;', '.field public static final RSSI_FIELD_NUMBER:I = 0x2', '.field public static final STATICBTADDRESS_FIELD_NUMBER:I = 0x1']

PATCHES = [
    {
        'id': 'com_xiaomi_idm_api_proto_IDMServiceProto__BTConfig__dynamicMethod',
    ...
    :pswitch_4  #0x3
    const-string p0, "staticBTAddress_"

    const-string p1, "rssi_"
    ...
    invoke-direct {p0, p1}, Lcom/xiaomi/idm/api/proto/IDMServiceProto$BTConfig$Builder;-><init>(Lcom/xiaomi/idm/api/proto/IDMServiceProto$1;)V
