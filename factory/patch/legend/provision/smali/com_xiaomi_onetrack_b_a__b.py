...
TARGET_CLASS = 'com/xiaomi/onetrack/b/a$b.smali'
CLASS_FALLBACK_NAMES = ['a$b.smali']
CLASS_ANCHORS = ['.super Landroid/os/Handler;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_b_a__b__class_delete',
        'type': 'class_delete',
        'search': """.class Lcom/xiaomi/onetrack/b/a$b;
