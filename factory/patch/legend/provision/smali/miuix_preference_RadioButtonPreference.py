...
TARGET_CLASS = 'miuix/preference/RadioButtonPreference.smali'
CLASS_FALLBACK_NAMES = ['RadioButtonPreference.smali']
CLASS_ANCHORS = ['.super Lmiuix/preference/BaseCheckBoxPreference;', '.implements Landroid/widget/Checkable;', '.implements Landroid/os/MessageQueue$IdleHandler;']

PATCHES = [
    {
        'id': 'miuix_preference_RadioButtonPreference__notifyChanged',
        'method': '.method protected notifyChanged()V',
        'method_name': 'notifyChanged',
        'method_anchors': ['invoke-super {p0}, Landroidx/preference/Preference;->notifyChanged()V', 'iget v0, p0, Lmiuix/preference/RadioButtonPreference;->mClicked:I', 'if-lez v0, :cond_0', 'iput v0, p0, Lmiuix/preference/RadioButtonPreference;->mClicked:I', 'iput-boolean v1, p0, Lmiuix/preference/RadioButtonPreference;->mIsNotifyChanged:Z', 'iget-object v0, p0, Lmiuix/preference/RadioButtonPreference;->mInternalListener:Lmiuix/preference/OnPreferenceChangeInternalListener;', 'if-eqz v0, :cond_1', 'invoke-interface {v0, p0}, Lmiuix/preference/OnPreferenceChangeInternalListener;->notifyPreferenceChangeInternal(Landroidx/preference/Preference;)V'],
        'type': 'method_replace',
...
.end method""",
    ...
    {
        'id': 'miuix_preference_RadioButtonPreference__onClick',
        'method': '.method protected onClick()V',
        'method_name': 'onClick',
        'method_anchors': ['iput-boolean v0, p0, Lmiuix/preference/RadioButtonPreference;->mChangeFromClick:Z', 'iput v0, p0, Lmiuix/preference/RadioButtonPreference;->mClicked:I', 'iput-boolean v0, p0, Lmiuix/preference/RadioButtonPreference;->mIsInit:Z', 'invoke-super {p0}, Landroidx/preference/TwoStatePreference;->onClick()V', 'iget-boolean v0, p0, Lmiuix/preference/RadioButtonPreference;->mChangeFromClick:Z', 'if-eqz v0, :cond_0', 'iget-object p0, p0, Lmiuix/preference/RadioButtonPreference;->mItemView:Landroid/view/View;', 'if-eqz p0, :cond_0'],
        'type': 'method_replace',
...
.end method""",
    ...
    {
        'id': 'miuix_preference_RadioButtonPreference__setOnPreferenceChangeInternalListener',
        ...
        'method_anchors': ['iput-object p1, p0, Lmiuix/preference/RadioButtonPreference;->mInternalListener:Lmiuix/preference/OnPreferenceChangeInternalListener;', 'return-void'],
        'type': 'method_replace',
