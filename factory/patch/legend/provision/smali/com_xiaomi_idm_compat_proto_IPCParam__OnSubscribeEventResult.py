...
TARGET_CLASS = 'com/xiaomi/idm/compat/proto/IPCParam$OnSubscribeEventResult.smali'
CLASS_FALLBACK_NAMES = ['IPCParam$OnSubscribeEventResult.smali']
CLASS_ANCHORS = ['.super Lcom/google/protobuf/GeneratedMessageLite;', '.implements Lcom/google/protobuf/MessageLiteOrBuilder;', '.field private static final DEFAULT_INSTANCE:Lcom/xiaomi/idm/compat/proto/IPCParam$OnSubscribeEventResult;', '.field public static final EVENTRESULT_FIELD_NUMBER:I = 0x1']

PATCHES = [
    {
        'id': 'com_xiaomi_idm_compat_proto_IPCParam__OnSubscribeEventResult__dynamicMethod',
    ...
    invoke-direct {p0, p1}, Lcom/xiaomi/idm/compat/proto/IPCParam$OnSubscribeEventResult$Builder;-><init>(Lcom/xiaomi/idm/compat/proto/IPCParam$1;)V
