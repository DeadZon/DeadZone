...
TARGET_CLASS = 'com/xiaomi/onetrack/g/c.smali'
CLASS_FALLBACK_NAMES = ['c.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_g_c__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/g/c;
