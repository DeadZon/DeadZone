...
TARGET_CLASS = 'com/miui/analytics/ITrack$Stub.smali'
CLASS_FALLBACK_NAMES = ['ITrack$Stub.smali']
CLASS_ANCHORS = ['.super Landroid/os/Binder;', '.implements Lcom/miui/analytics/ITrack;']

PATCHES = [
    {
        'id': 'com_miui_analytics_ITrack__Stub__class_delete',
        'type': 'class_delete',
        'search': """.class public abstract Lcom/miui/analytics/ITrack$Stub;
