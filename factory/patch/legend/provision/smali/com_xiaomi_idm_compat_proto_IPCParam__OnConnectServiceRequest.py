...
TARGET_CLASS = 'com/xiaomi/idm/compat/proto/IPCParam$OnConnectServiceRequest.smali'
CLASS_FALLBACK_NAMES = ['IPCParam$OnConnectServiceRequest.smali']
CLASS_ANCHORS = ['.super Lcom/google/protobuf/GeneratedMessageLite;', '.implements Lcom/google/protobuf/MessageLiteOrBuilder;', '.field private static final DEFAULT_INSTANCE:Lcom/xiaomi/idm/compat/proto/IPCParam$OnConnectServiceRequest;', '.field public static final IDMCONNECTSERVICEREQUEST_FIELD_NUMBER:I = 0x1']

PATCHES = [
    {
        'id': 'com_xiaomi_idm_compat_proto_IPCParam__OnConnectServiceRequest__dynamicMethod',
    ...
    :pswitch_4  #0x3
    const-string p0, "idmConnectServiceRequest_"
    ...
    invoke-direct {p0, p1}, Lcom/xiaomi/idm/compat/proto/IPCParam$OnConnectServiceRequest$Builder;-><init>(Lcom/xiaomi/idm/compat/proto/IPCParam$1;)V
