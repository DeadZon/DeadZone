...
TARGET_CLASS = 'com/xiaomi/onetrack/util/o.smali'
CLASS_FALLBACK_NAMES = ['o.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;', '.field private static final a:Ljava/lang/String; = "o"']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_util_o__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/util/o;
