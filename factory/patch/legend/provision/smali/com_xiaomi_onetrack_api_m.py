...
TARGET_CLASS = 'com/xiaomi/onetrack/api/m.smali'
CLASS_FALLBACK_NAMES = ['m.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_api_m__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/api/m;
...
.method private o()V
    ...
    iget-object v10, p0, Lcom/xiaomi/onetrack/api/m;->i:Lcom/xiaomi/onetrack/util/v;
