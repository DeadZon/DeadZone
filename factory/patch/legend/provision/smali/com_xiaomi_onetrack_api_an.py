...
TARGET_CLASS = 'com/xiaomi/onetrack/api/an.smali'
CLASS_FALLBACK_NAMES = ['an.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;', '.implements Lcom/xiaomi/onetrack/api/j;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_api_an__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/api/an;
...
.method public a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/xiaomi/onetrack/api/an;->f:Lcom/xiaomi/onetrack/util/v;
