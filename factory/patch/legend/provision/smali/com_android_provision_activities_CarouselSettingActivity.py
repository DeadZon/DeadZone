...
TARGET_CLASS = 'com/android/provision/activities/CarouselSettingActivity.smali'
CLASS_FALLBACK_NAMES = ['CarouselSettingActivity.smali']
CLASS_ANCHORS = ['.super Lcom/android/provision/activities/BaseActivity;']

PATCHES = [
    {
        'id': 'com_android_provision_activities_CarouselSettingActivity__getFragment',
        'method': '.method protected getFragment()Landroidx/fragment/app/Fragment;',
        'method_name': 'getFragment',
        'method_anchors': ['new-instance p0, Lcom/android/provision/fragment/CarouselSettingFragment;', 'invoke-direct {p0}, Lcom/android/provision/fragment/CarouselSettingFragment;-><init>()V', 'return-object p0'],
        'type': 'method_replace',
        'search': """.method protected getFragment()Landroidx/fragment/app/Fragment;
    .registers 1

    new-instance p0, Lcom/android/provision/fragment/CarouselSettingFragment;

    invoke-direct {p0}, Lcom/android/provision/fragment/CarouselSettingFragment;-><init>()V
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_CarouselSettingActivity__getFragmentTag',
    ...
    const-class p0, Lcom/android/provision/fragment/CarouselSettingFragment;
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_CarouselSettingActivity__getListDescCharSequence',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_CarouselSettingActivity__getLogoDrawableId',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_CarouselSettingActivity__getTitleStringId',
        'method': '.method protected getTitleStringId()I',
        'method_name': 'getTitleStringId',
        'method_anchors': ['sget p0, Lcom/android/provision/R$string;->carousel_setting:I', 'return p0'],
        'type': 'method_replace',
        'search': """.method protected getTitleStringId()I
    .registers 1

    sget p0, Lcom/android/provision/R$string;->carousel_setting:I
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_CarouselSettingActivity__onCreate',
