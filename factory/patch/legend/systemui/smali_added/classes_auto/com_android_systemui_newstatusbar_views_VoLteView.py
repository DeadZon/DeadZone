...
TARGET_CLASS = 'com/android/systemui/newstatusbar/views/VoLteView.smali'
CLASS_FALLBACK_NAMES = ['VoLteView.smali']
REQUIRED = True
REASON = "Legend MiuiSystemUI converted dex payload added class"
CLASS_CONTENT = """.class public Lcom/android/systemui/newstatusbar/views/VoLteView;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/systemui/newstatusbar/views/VoLteView;->iconController:Lcom/android/systemui/newstatusbar/controllers/CustomIconController;
...
.method protected onAttached()V
    ...
    :goto_12
    iget-object v0, p0, Lcom/android/systemui/newstatusbar/views/VoLteView;->iconController:Lcom/android/systemui/newstatusbar/controllers/CustomIconController;
...
.method public onIconStyleChange()V
    ...
    iget v1, p0, Lcom/android/systemui/newstatusbar/views/VoLteView;->mIds:I

    invoke-virtual {v0, v1}, Lcom/android/systemui/newstatusbar/controllers/CustomIconController;->getVoLteIds(I)I
...
.method public setImageResource(I)V
    ...
    iput p1, p0, Lcom/android/systemui/newstatusbar/views/VoLteView;->mIds:I
    ...
    invoke-virtual {v0, p1}, Lcom/android/systemui/newstatusbar/controllers/CustomIconController;->getVoLteIds(I)I
...
PATCHES = [
    {
        "id": 'class_add_com_android_systemui_newstatusbar_views_VoLteView',
        "type": "class_add",
        "method": "",
        "method_name": "",
        "search": None,
