...
CLASS_CONTENT = """.class public interface abstract Lcom/android/systemui/newstatusbar/controllers/SimTypeController$CallBack;
...
PATCHES = [
    {
        "id": 'class_add_com_android_systemui_newstatusbar_controllers_SimTypeController_CallBack',
        "type": "class_add",
        "method": "",
        "method_name": "",
        "search": None,
