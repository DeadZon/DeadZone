...
Target class : com/android/systemui/newstatusbar/controllers/MobileIconColorSizeController$3.smali
DEX group    : classes2
"""
from __future__ import annotations

TARGET_APK           = 'MiuiSystemUI.apk'
TARGET_CLASS         = 'com/android/systemui/newstatusbar/controllers/MobileIconColorSizeController$3.smali'
CLASS_FALLBACK_NAMES = ['MobileIconColorSizeController$3.smali']
DEX_GROUP            = 'classes2'
