...
Target class : com/android/systemui/newstatusbar/controllers/StatusBarIconViewController$2.smali
DEX group    : classes2
"""
from __future__ import annotations

TARGET_APK           = 'MiuiSystemUI.apk'
TARGET_CLASS         = 'com/android/systemui/newstatusbar/controllers/StatusBarIconViewController$2.smali'
CLASS_FALLBACK_NAMES = ['StatusBarIconViewController$2.smali']
DEX_GROUP            = 'classes2'
