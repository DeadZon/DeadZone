...
Target class : com/android/systemui/newstatusbar/views/NotificationHeaderDateView$1$2.smali
DEX group    : classes2
"""
from __future__ import annotations

TARGET_APK           = 'MiuiSystemUI.apk'
TARGET_CLASS         = 'com/android/systemui/newstatusbar/views/NotificationHeaderDateView$1$2.smali'
CLASS_FALLBACK_NAMES = ['NotificationHeaderDateView$1$2.smali']
DEX_GROUP            = 'classes2'
