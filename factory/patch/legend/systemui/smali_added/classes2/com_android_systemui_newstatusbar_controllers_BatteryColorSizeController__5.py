...
Target class : com/android/systemui/newstatusbar/controllers/BatteryColorSizeController$5.smali
DEX group    : classes2
"""
from __future__ import annotations

TARGET_APK           = 'MiuiSystemUI.apk'
TARGET_CLASS         = 'com/android/systemui/newstatusbar/controllers/BatteryColorSizeController$5.smali'
CLASS_FALLBACK_NAMES = ['BatteryColorSizeController$5.smali']
DEX_GROUP            = 'classes2'
