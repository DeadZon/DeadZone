...
Target class : android/Utils/ImageUtils
...
TARGET_CLASS = "android/Utils/ImageUtils.smali"
CLASS_FALLBACK_NAMES = ['ImageUtils.smali']
CLASS_ANCHORS        = []

PATCHES = [
    {
        "id":          "add_class_android_Utils_ImageUtils",
        "method":      "",
        "type":        "class_add",
        "search":      None,
        "replacement": """\
