...
TARGET_CLASS = 'com/xiaomi/idm/compat/proto/IPCParam$BlockFragment.smali'
CLASS_FALLBACK_NAMES = ['IPCParam$BlockFragment.smali']
CLASS_ANCHORS = ['.super Lcom/google/protobuf/GeneratedMessageLite;', '.implements Lcom/google/protobuf/MessageLiteOrBuilder;', '.field public static final BLOCKID_FIELD_NUMBER:I = 0x5', '.field public static final BLOCKSIZE_FIELD_NUMBER:I = 0x6', '.field private static final DEFAULT_INSTANCE:Lcom/xiaomi/idm/compat/proto/IPCParam$BlockFragment;', '.field public static final FRAGMENTOFFSET_FIELD_NUMBER:I = 0x4']

PATCHES = [
    {
        'id': 'com_xiaomi_idm_compat_proto_IPCParam__BlockFragment__dynamicMethod',
    ...
    :pswitch_4  #0x3
    const-string p0, "fragmentSize_"

    const-string p1, "fragmentOffset_"

    const-string p2, "blockId_"

    const-string p3, "blockSize_"
    ...
    invoke-direct {p0, p1}, Lcom/xiaomi/idm/compat/proto/IPCParam$BlockFragment$Builder;-><init>(Lcom/xiaomi/idm/compat/proto/IPCParam$1;)V
