...
TARGET_CLASS = 'com/android/provision/activities/DefaultActivity$TermsAndStatementState.smali'
CLASS_FALLBACK_NAMES = ['DefaultActivity$TermsAndStatementState.smali']
CLASS_ANCHORS = ['.super Lcom/android/provision/activities/DefaultActivity$State;']

PATCHES = [
    {
        'id': 'com_android_provision_activities_DefaultActivity__TermsAndStatementState__isAvailable',
