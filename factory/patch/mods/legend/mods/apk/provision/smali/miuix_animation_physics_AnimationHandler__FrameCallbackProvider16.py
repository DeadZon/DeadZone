...
TARGET_CLASS = 'miuix/animation/physics/AnimationHandler$FrameCallbackProvider16.smali'
CLASS_FALLBACK_NAMES = ['AnimationHandler$FrameCallbackProvider16.smali']
CLASS_ANCHORS = ['.super Lmiuix/animation/physics/AnimationHandler$AnimationFrameCallbackProvider;']

PATCHES = [
    {
        'id': 'miuix_animation_physics_AnimationHandler__FrameCallbackProvider16__getLooper',
        'method': '.method getLooper()Landroid/os/Looper;',
        'method_name': 'getLooper',
        'method_anchors': ['iget-object p0, p0, Lmiuix/animation/physics/AnimationHandler$FrameCallbackProvider16;->mLooper:Landroid/os/Looper;', 'return-object p0'],
        'type': 'method_replace',
...
.end method""",
    ...
    {
        'id': 'miuix_animation_physics_AnimationHandler__FrameCallbackProvider16__isCurrentThread',
        'method': '.method isCurrentThread()Z',
        'method_name': 'isCurrentThread',
        'method_anchors': ['invoke-static {}, Ljava/lang/Thread;->currentThread()Ljava/lang/Thread;', 'iget-object p0, p0, Lmiuix/animation/physics/AnimationHandler$FrameCallbackProvider16;->mLooper:Landroid/os/Looper;', 'invoke-virtual {p0}, Landroid/os/Looper;->getThread()Ljava/lang/Thread;', 'if-ne v0, p0, :cond_0', 'return p0', 'return p0'],
        'type': 'method_replace',
