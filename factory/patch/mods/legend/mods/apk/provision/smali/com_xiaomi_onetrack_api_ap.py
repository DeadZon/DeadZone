...
TARGET_CLASS = 'com/xiaomi/onetrack/api/ap.smali'
CLASS_FALLBACK_NAMES = ['ap.smali']
CLASS_ANCHORS = ['.super Ljava/lang/Object;', '.implements Lcom/xiaomi/onetrack/api/as$a;', '.implements Lcom/xiaomi/onetrack/api/j;']

PATCHES = [
    {
        'id': 'com_xiaomi_onetrack_api_ap__class_delete',
        'type': 'class_delete',
        'search': """.class public Lcom/xiaomi/onetrack/api/ap;
