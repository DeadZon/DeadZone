...
TARGET_CLASS = 'miuix/animation/motion/FreeDampedMotion.smali'
CLASS_FALLBACK_NAMES = ['FreeDampedMotion.smali']
CLASS_ANCHORS = ['.super Lmiuix/animation/motion/BaseMotion;', '.implements Lmiuix/animation/motion/Motion;']

PATCHES = [
    {
        'id': 'miuix_animation_motion_FreeDampedMotion__onInitialVChanged',
        'method': '.method protected onInitialVChanged()V',
        'method_name': 'onInitialVChanged',
        'method_anchors': ['invoke-super {p0}, Lmiuix/animation/motion/BaseMotion;->onInitialVChanged()V', 'iput-object v0, p0, Lmiuix/animation/motion/FreeDampedMotion;->function:Lmiuix/animation/function/Differentiable;', 'return-void'],
        'type': 'method_replace',
...
.end method""",
    ...
    {
        'id': 'miuix_animation_motion_FreeDampedMotion__onInitialXChanged',
        'method': '.method protected onInitialXChanged()V',
        'method_name': 'onInitialXChanged',
        'method_anchors': ['invoke-super {p0}, Lmiuix/animation/motion/BaseMotion;->onInitialXChanged()V', 'iput-object v0, p0, Lmiuix/animation/motion/FreeDampedMotion;->function:Lmiuix/animation/function/Differentiable;', 'return-void'],
        'type': 'method_replace',
