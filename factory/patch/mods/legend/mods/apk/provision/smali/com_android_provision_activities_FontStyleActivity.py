...
TARGET_CLASS = 'com/android/provision/activities/FontStyleActivity.smali'
CLASS_FALLBACK_NAMES = ['FontStyleActivity.smali']
CLASS_ANCHORS = ['.super Lcom/android/provision/activities/BaseActivity;']

PATCHES = [
    {
        'id': 'com_android_provision_activities_FontStyleActivity__getFragment',
        'method': '.method protected getFragment()Landroidx/fragment/app/Fragment;',
        'method_name': 'getFragment',
        'method_anchors': ['new-instance p0, Lcom/android/provision/fragment/FontStyleFragment;', 'invoke-direct {p0}, Lcom/android/provision/fragment/FontStyleFragment;-><init>()V', 'return-object p0'],
        'type': 'method_replace',
        'search': """.method protected getFragment()Landroidx/fragment/app/Fragment;
    .registers 1

    new-instance p0, Lcom/android/provision/fragment/FontStyleFragment;

    invoke-direct {p0}, Lcom/android/provision/fragment/FontStyleFragment;-><init>()V
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_FontStyleActivity__getFragmentTag',
    ...
    const-class p0, Lcom/android/provision/fragment/FontStyleFragment;
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_FontStyleActivity__getListDescCharSequence',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_FontStyleActivity__getLogoDrawableId',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_FontStyleActivity__getTitleStringId',
        'method': '.method protected getTitleStringId()I',
        'method_name': 'getTitleStringId',
        'method_anchors': ['sget p0, Lcom/android/provision/R$string;->font_settings_title:I', 'return p0'],
        'type': 'method_replace',
        'search': """.method protected getTitleStringId()I
    .registers 1

    sget p0, Lcom/android/provision/R$string;->font_settings_title:I
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_FontStyleActivity__onCreate',
        'method': '.method protected onCreate(Landroid/os/Bundle;)V',
        'method_name': 'onCreate',
        'method_anchors': ['invoke-super {p0, p1}, Lcom/android/provision/activities/BaseActivity;->onCreate(Landroid/os/Bundle;)V', 'const-string p1, "font.json"', 'invoke-virtual {p0, p1}, Lmiuix/provision/ProvisionBaseActivity;->setAnimationView(Ljava/lang/String;)V', 'return-void'],
        'type': 'method_replace',
