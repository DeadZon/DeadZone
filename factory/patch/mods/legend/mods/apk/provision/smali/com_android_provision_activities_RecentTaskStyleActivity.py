...
TARGET_CLASS = 'com/android/provision/activities/RecentTaskStyleActivity.smali'
CLASS_FALLBACK_NAMES = ['RecentTaskStyleActivity.smali']
CLASS_ANCHORS = ['.super Lcom/android/provision/activities/BaseActivity;']

PATCHES = [
    {
        'id': 'com_android_provision_activities_RecentTaskStyleActivity__getFragment',
        'method': '.method protected getFragment()Landroidx/fragment/app/Fragment;',
        'method_name': 'getFragment',
        'method_anchors': ['new-instance p0, Lcom/android/provision/fragment/RecentTaskStyleFragment;', 'invoke-direct {p0}, Lcom/android/provision/fragment/RecentTaskStyleFragment;-><init>()V', 'return-object p0'],
        'type': 'method_replace',
        'search': """.method protected getFragment()Landroidx/fragment/app/Fragment;
    .registers 1

    new-instance p0, Lcom/android/provision/fragment/RecentTaskStyleFragment;

    invoke-direct {p0}, Lcom/android/provision/fragment/RecentTaskStyleFragment;-><init>()V
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_RecentTaskStyleActivity__getFragmentTag',
    ...
    const-class p0, Lcom/android/provision/fragment/RecentTaskStyleFragment;
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_RecentTaskStyleActivity__getListDescCharSequence',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_RecentTaskStyleActivity__getLogoDrawableId',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_RecentTaskStyleActivity__getTitleStringId',
        'method': '.method protected getTitleStringId()I',
        'method_name': 'getTitleStringId',
        'method_anchors': ['sget p0, Lcom/android/provision/R$string;->title_recent_tasks_style:I', 'return p0'],
        'type': 'method_replace',
        'search': """.method protected getTitleStringId()I
    .registers 1

    sget p0, Lcom/android/provision/R$string;->title_recent_tasks_style:I
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_RecentTaskStyleActivity__onCreate',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_RecentTaskStyleActivity__onNewIntent',
