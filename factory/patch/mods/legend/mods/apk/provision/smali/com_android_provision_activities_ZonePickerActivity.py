...
TARGET_CLASS = 'com/android/provision/activities/ZonePickerActivity.smali'
CLASS_FALLBACK_NAMES = ['ZonePickerActivity.smali']
CLASS_ANCHORS = ['.super Lcom/android/provision/activities/BaseActivity;']

PATCHES = [
    {
        'id': 'com_android_provision_activities_ZonePickerActivity__getFragment',
        'method': '.method protected getFragment()Landroidx/fragment/app/Fragment;',
        'method_name': 'getFragment',
        'method_anchors': ['new-instance p0, Lcom/android/provision/fragment/ZonePickerFragment;', 'invoke-direct {p0}, Lcom/android/provision/fragment/ZonePickerFragment;-><init>()V', 'return-object p0'],
        'type': 'method_replace',
        'search': """.method protected getFragment()Landroidx/fragment/app/Fragment;
    .registers 1

    new-instance p0, Lcom/android/provision/fragment/ZonePickerFragment;

    invoke-direct {p0}, Lcom/android/provision/fragment/ZonePickerFragment;-><init>()V
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_ZonePickerActivity__getFragmentTag',
    ...
    const-class p0, Lcom/android/provision/fragment/ZonePickerFragment;
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_ZonePickerActivity__getListDescCharSequence',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_ZonePickerActivity__getLogoDrawableId',
...
.end method""",
    ...
    {
        'id': 'com_android_provision_activities_ZonePickerActivity__getTitleStringId',
        'method': '.method protected getTitleStringId()I',
        'method_name': 'getTitleStringId',
        'method_anchors': ['sget p0, Lcom/android/provision/R$string;->zone_picker_title:I', 'return p0'],
        'type': 'method_replace',
        'search': """.method protected getTitleStringId()I
    .registers 1

    sget p0, Lcom/android/provision/R$string;->zone_picker_title:I
