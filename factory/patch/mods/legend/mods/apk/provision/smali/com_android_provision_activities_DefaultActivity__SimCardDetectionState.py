...
TARGET_CLASS = 'com/android/provision/activities/DefaultActivity$SimCardDetectionState.smali'
CLASS_FALLBACK_NAMES = ['DefaultActivity$SimCardDetectionState.smali']
CLASS_ANCHORS = ['.super Lcom/android/provision/activities/DefaultActivity$State;']

PATCHES = [
    {
        'id': 'com_android_provision_activities_DefaultActivity__SimCardDetectionState__getIntent',
        'method': '.method protected getIntent()Landroid/content/Intent;',
        'method_name': 'getIntent',
        'method_anchors': ['invoke-super {p0}, Lcom/android/provision/activities/DefaultActivity$State;->getIntent()Landroid/content/Intent;', 'if-eqz p0, :cond_0', 'sget-boolean v0, Lmiui/enterprise/EnterpriseManagerStub;->ENTERPRISE_ACTIVATED:Z', 'if-eqz v0, :cond_0', 'const-string v0, "from_provision"', 'invoke-virtual {p0, v0, v1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;', 'return-object p0'],
        'type': 'method_replace',
