...
TARGET_CLASS = 'com/android/systemui/newstatusbar/views/CustSimIcon.smali'
CLASS_FALLBACK_NAMES = ['CustSimIcon.smali']
REQUIRED = True
REASON = "Legend MiuiSystemUI converted dex payload added class"
CLASS_CONTENT = """.class public Lcom/android/systemui/newstatusbar/views/CustSimIcon;
...
PATCHES = [
    {
        "id": 'class_add_com_android_systemui_newstatusbar_views_CustSimIcon',
        "type": "class_add",
        "method": "",
        "method_name": "",
        "search": None,
