...
TARGET_CLASS = 'com/android/systemui/newstatusbar/views/ext/ExtIconMobileAnimator.smali'
CLASS_FALLBACK_NAMES = ['ExtIconMobileAnimator.smali']
REQUIRED = True
REASON = "Legend MiuiSystemUI converted dex payload added class"
CLASS_CONTENT = """.class public abstract Lcom/android/systemui/newstatusbar/views/ext/ExtIconMobileAnimator;
...
PATCHES = [
    {
        "id": 'class_add_com_android_systemui_newstatusbar_views_ext_ExtIconMobileAnimator',
        "type": "class_add",
        "method": "",
        "method_name": "",
        "search": None,
