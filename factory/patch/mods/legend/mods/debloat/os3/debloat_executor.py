...
CLI:
  ...
  python -m factory.patch.mods.legend.mods.debloat.os3.debloat_executor \\
...
from factory.patch.mods.legend.mods.debloat.os3.legend_profile import guard as _profile_guard
