...
echo %CYAN%%BOLD%   DeadZone ROM Installer — Upgrade Mode (Keep User Data)%RESET%
...
:: ============================================================
::  CONFIRM UPGRADE FLASH
:: ============================================================
echo %CYAN%%BOLD%  ============================================================%RESET%
echo %CYAN%%BOLD%   UPGRADE MODE — User data will NOT be wiped.%RESET%
echo %CYAN%%BOLD%   Use windows_install_and_format_data.bat for a clean flash.%RESET%
echo %CYAN%%BOLD%  ============================================================%RESET%
echo.
echo %WHITE%Press any key to begin flashing, or close this window to cancel.%RESET%
pause >nul
echo.
...
if exist "images\preloader_raw.img" (
    ...
    echo %YELLOW%  Flashing the wrong preloader can permanently brick your device.%RESET%
...
echo %GREEN%%BOLD%   [DEADZONE OK] Upgrade flash complete.%RESET%
